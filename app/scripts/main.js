    ...
    initEvents: function () {
      $(".intro").on("submit", function (event) {
        ...
        if (monthCount(myDate) === 8 ){
          $(".listCreate").prepend("<h2>While You're Eight Months Out: </h2>");
        ...
        if (monthCount(myDate) < 8 && monthCount(myDate) > 5 ){
          $(".listCreate").prepend("<h2>Between Seven and Six Months Out:</h2>");
        ...
        if (monthCount(myDate) < 6 && monthCount(myDate) > 3){
          $(".listCreate").prepend("<h2>Between Four and Five Months Out:</h2>");
        ...
        if (monthCount(myDate) === 3){
          $(".listCreate").prepend("<h2>While You're Three Months Out:</h2>");
        ...
        if (monthCount(myDate) === 2){
          $(".listCreate").prepend("<h2>Two Months to Go, You Should:</h2>");
